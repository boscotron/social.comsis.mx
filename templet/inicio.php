    ...
    <div class="tp-banner" >
        <ul>
            <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                <img src="<?php $this->url_templet(); ?>images/slider/02.jpg" alt="slider-image" />
                <div class="tp-caption sfr title-slide center bsk-fondo-obscuro  jmy_web_div" id="slider_2_titulo" data-page="inicio" data-editable="no" data-x="0" data-y="250" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">
                   <?php $this->pnt('slider_2_titulo','Personalizamos tu marca'); ?>
                </div>  
                <div class="tp-caption sfr desc-slide center bsk-fondo-obscuro jmy_web_div" id="slider_2_sub" data-page="inicio" data-editable="no" data-x="0" data-y="215" data-speed="1000" data-start="1500" data-easing="Power3.easeInOut">
                   <?php $this->pnt('slider_2_sub','Diseño'); ?></div>    

                                        

                <div class="tp-caption sfr flat-button-slider bg-button-slider-32bfc0" data-x="0" data-y="450" data-speed="1000" data-start="2500" data-easing="Power3.easeInOut"><a href="<?php $this->url_inicio(); ?>servicios/comsis-diseno">Leer más</a> &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right"></i></div>
            </li>
            <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                <img src="<?php $this->url_templet(); ?>images/slider/01.jpg" alt="slider-image" />
                <div class="tp-caption sfl title-slide center bsk-fondo-obscuro jmy_web_div" id="slider_1_titulo" data-page="inicio" data-editable="no" data-x="319" data-y="300" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut"><?php $this->pnt('slider_1_titulo','Creamos tu marca'); ?>
                </div>  
                <div class="tp-caption sfr desc-slide center bsk-fondo-obscuro jmy_web_div" id="slider_1_sub" data-page="inicio" data-editable="no" data-x="363" data-y="260" data-speed="1000" data-start="1500" data-easing="Power3.easeInOut"><?php $this->pnt('slider_1_sub','Mercadotecnia Digital '); ?>
                </div>    
                <div class="tp-caption sfl flat-button-slider bg-button-slider-32bfc0 " data-x="420" data-y="410" data-speed="1000" data-start="2000" data-easing="Power3.easeInOut"><a href="<?php $this->url_inicio(); ?>servicios/comsis-redes">Leer más</a> &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right"></i></div>

                <div class="tp-caption sfr flat-button-slider" data-x="600" data-y="410" data-speed="1000" data-start="2000" data-easing="Power3.easeInOut"><a href="<?php echo $linkWhathsApp; ?>">Contáctanos</a>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right"></i></div>
            </li>

            <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                <img src="<?php $this->url_templet(); ?>images/slider/03.jpg" alt="slider-image" />
                <div class="tp-caption sfl title-slide center bsk-fondo-obscuro  jmy_web_div" id="slider_3_titulo" data-page="inicio" data-editable="no" data-x="405" data-y="255" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut" ><?php $this->pnt('slider_3_titulo','Vendemos tu marca'); ?>
                </div>  
                <div class="tp-caption sfr desc-slide center bsk-fondo-obscuro  jmy_web_div" id="slider_3_sub" data-page="inicio" data-editable="no" data-x="605" data-y="215" data-speed="1000" data-start="1500" data-easing="Power3.easeInOut"><?php $this->pnt('slider_3_sub','Publicidad Digital '); ?>
                </div>  

                          
                <div class="tp-caption sfl flat-button-slider bg-button-slider-32bfc0" data-x="605" data-y="430" data-speed="1000" data-start="2000" data-easing="Power3.easeInOut"><a href="<?php $this->url_inicio(); ?>servicios/comsis-ecommerce">Leer más</a> &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right"></i></div>

                <div class="tp-caption sfr flat-button-slider" data-x="790" data-y="430" data-speed="1000" data-start="2000" data-easing="Power3.easeInOut"><a href="<?php echo $linkWhathsApp; ?>">Contáctanos</a>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-right"></i></div>
            </li>
                ...
                <div class="images-box  clear-fix show">  <div class="jmy_web_div" id="paquete_img_4" data-page="inicio"> <?php $this->pnt('paquete_img_4','<img src="'.RUTA_ACTUAL.BASE_TEMPLET.'/images/paquetes/2.jpg" alt="serives"> '); ?> </div>
                    <div class="box-content descripcionServicios">
                        ...
                        <div class="jmy_web_div" id="paquete_descripcion_4" data-page="inicio"  >
                         ...
                         <a href="<?php $this->url_inicio(); ?>paquetes/paquete-web" class="box-redmore">Leer más</a>
                    </div>                                
                </div><!-- /.images-box -->    
                ...
                <div class="images-box  clear-fix"><div class="jmy_web_div" id="paquete_img_5" data-page="inicio"> <?php $this->pnt('paquete_img_5','<img src="'.RUTA_ACTUAL.BASE_TEMPLET.'/images/paquetes/3.jpg" alt="serives"> '); ?> </div>
                    <div class="box-content descripcionServicios">
                        ...
                        <div class="jmy_web_div" id="paquete_descripcion_5" data-page="inicio"  >
                         ...
                         </div><a href="<?php $this->url_inicio(); ?>paquetes/paquete-e-commerce" class="box-redmore">Leer más</a>
                    </div>                                
                </div><!-- /.images-box -->    
